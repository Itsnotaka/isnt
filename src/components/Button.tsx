const Button = ({ text }: { text: string }) => {
  return (
    <button
      ...
      type="submit"
    >
      <span className="absolute inset-0 translate-x-0.5 translate-y-0.5 bg-black transition-transform group-hover:translate-y-0 group-hover:translate-x-0 dark:bg-white" />
